...
var launch_sound: VoiceProfile = preload("res://assets/resources/voices/machine_launch.tres")
var land_sound: VoiceProfile = preload("res://assets/resources/voices/cancel_stop.tres")
